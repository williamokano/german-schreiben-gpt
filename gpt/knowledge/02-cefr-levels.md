# CEFR Level Profiles for German Writing (A1–C2)

Reference document for Deutsch Schreibtrainer. Everything — exercises, expected structures, feedback depth, micro-challenges — calibrates to these profiles. Core rule: teach and demand *at* level, tolerate errors *above* level, correct patterns *at or below* level.

## Quick Comparison

| | A1 | A2 | B1 | B2 | C1 | C2 |
|---|---|---|---|---|---|---|
| Text length (typical task) | 20–30 words | 30–80 words | 80–120 words | 150–250 words | 230–350 words | 350+ words |
| Text types | Forms, notes | Short e-mails, postcards | Letters, forum posts | Argumentation, complaints, reports | Essays, articles | Any type, any register |
| Sentence architecture | Main clauses | + weil/dass/wenn | All common subordinate clauses | Complex, varied | Nominal style, participles | Full stylistic control |
| Feedback focus | Communication succeeds | Verb position, Perfekt, Dativ | Case system, text structure | Precision, register, cohesion | Style, idiomaticity | Nuance, rhythm, voice |
| Error tolerance | High — meaning first | High on anything beyond core | Medium on B1 grammar | Low on B1 grammar, medium on B2 | Low overall | Near-native expected |

## A1

**Can-do (writing):** fill in forms (name, address, nationality); write a short simple note or message (~30 words) with memorized patterns: greeting, 2–3 facts, closing.

**Grammar inventory**

| Secure (expect & correct) | Emerging (encourage, tolerate errors) | Off-limits (never demand or explain) |
|---|---|---|
...
**Micro-challenges:** "Schreib 3 Sätze über deine Familie."; "Benutze einmal 'um … Uhr'."; "Beginne einen Satz mit 'Am Samstag' — wo steht das Verb?"

**Natural at A1** = short, correct, formulaic. Do not push variety.

## A2

**Can-do:** short personal e-mails/letters (invitations, thanks, apologies, plans); describe past events simply; ~30–80 words with basic connectors.

**Grammar inventory**

| Secure | Emerging | Off-limits |
|---|---|---|
...
**Micro-challenges:** "Benutze zweimal 'weil' — Verb ans Ende!"; "Erzähl es im Perfekt."; "Ein Satz mit 'Ich möchte …, weil …'."

**Natural at A2** = clear sequencing (zuerst, dann, danach), correct greetings/closings for informal messages.

## B1

**Can-do:** coherent connected texts on familiar topics; semi-formal letters (Anfrage, Beschwerde, Entschuldigung, Bewerbung einfach); express opinion with reasons; ~80–120 words. This is the DTZ / Zertifikat-Deutsch level.
...
**Micro-challenges:** "Eine Beschwerde mit 'Ich wäre Ihnen dankbar, wenn …'."; "Benutze 'obwohl' und 'trotzdem' im selben Text."; "Ein Relativsatz im ersten Absatz."

**Natural at B1** = correct Briefkonventionen, varied connectors beyond und/aber/dann, consistent register.

## B2

**Can-do:** clear detailed texts, argumentation with pros/cons and concession, formal complaints and applications, reports; ~150–250 words; register shifts on purpose.
...
**Micro-challenges:** "Formuliere zwei Sätze im Passiv um."; "Eine Konzession: 'Zwar …, aber …'."; "Ersetze dreimal 'machen' durch ein präziseres Verb."

**Natural at B2** = argumentation that flows (concession before counter-argument), collocational accuracy, no du/Sie slips ever.

## C1

**Can-do:** well-structured texts on complex subjects; essays and articles with controlled style; implicit meaning; ~230–350 words; effortless register control.
...
**Micro-challenges:** "Verdichte diesen Absatz um 30 % ohne Informationsverlust."; "Gib die Kritik in indirekter Rede wieder (Konjunktiv I)."; "Ein Partizipialattribut statt eines Relativsatzes."

**Natural at C1** = the text could appear in a quality newspaper's letters section without raising eyebrows.

## C2

**Can-do:** everything, in any register, with personal voice; summaries and critiques of complex texts; stylistic play.

**Feedback style:** you are an editor, not a teacher. Feedback addresses: precision vs. redundancy, register micro-shifts, connotation, rhythm, structural elegance, genre conventions (Feuilleton vs. Gutachten vs. Essay). Grammar errors are treated as slips, corrected with a code tag and no discussion. Always distinguish "I would phrase it differently" (taste — label it as such) from "this is off" (convention/connotation — explain why).

**Micro-challenges:** "Schreib dieselbe Passage einmal nüchtern-sachlich, einmal pointiert-feuilletonistisch."; "Streiche jedes entbehrliche Adverb."

## Cross-Level Rules

1. **Level mismatch in tasks:** if a student repeatedly performs above the session level, offer a level bump explicitly and update the session card. Never silently escalate difficulty.
